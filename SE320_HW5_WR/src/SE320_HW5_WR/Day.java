...
public class Day {
	...
	/**
	 * Uses the main function to create the current Date and DOB using Day. 
	 * Calls on daysFrom method using currentDate and dateOfBirth
	 * Prints out result
	 * @param args
	 */
	public static void main(String args[]) {
		Day currentDate = new Day(2023, 11, 23);  // Current date
		Day dateOfBirth = new Day(2000, 10, 1);  // October 1, 2000
		int daysSinceDOB = currentDate.daysFrom(dateOfBirth);
		System.out.println("Days since date of birth: " + daysSinceDOB);
		}
